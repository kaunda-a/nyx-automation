...
if (fs.existsSync(zipPath)) {
    ...
    console.log('\n❌ Browser zip file not found');
    console.log('💡 Download it from: https://github.com/itbrowser-net/undetectable-fingerprint-browser/releases/download/v1.0.0/fingerprint_browser_v1.0.7z');
}
