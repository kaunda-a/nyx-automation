...
// Fallback for fontFamily.sans in case it's undefined
const sansFonts = fontFamily?.sans || ['ui-sans-serif', 'system-ui', 'sans-serif']
...
export default {
  ...
  theme: {
    ...
    extend: {
      fontFamily: {
        inter: ['Inter', ...sansFonts],
        manrope: ['Manrope', ...sansFonts],
      },
      borderRadius: {
        lg: 'var(--radius)',
